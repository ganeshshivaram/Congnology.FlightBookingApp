namespace Cognology.FlightBookingApp.Migrations
{
    ...
    public partial class DataModelCreation : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FlightInformation_Id = c.Int(),
                    })
                .PrimaryKey(t => t.BookingId)
                .ForeignKey("dbo.Flights", t => t.FlightInformation_Id)
                .Index(t => t.FlightInformation_Id);
